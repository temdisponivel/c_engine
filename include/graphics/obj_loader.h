...
// OBJ_Loader.h - A Single Header OBJ Model Loader (https://raw.githubusercontent.com/Bly7/OBJ-Loader/master/Source/OBJ_Loader.h)
...
//                }
            ...
            for (int i = 0; i < MeshMatNames.size(); i++)
            {
                ...
                LoadedMeshes[i].MaterialName = MeshMatNames[i].c_str();
