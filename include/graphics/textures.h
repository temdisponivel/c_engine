...
enum TEXTURE_INDEX {
    TEX_ZERO = GL_TEXTURE0,
    TEX_ONE = GL_TEXTURE1,
    TEX_TWO = GL_TEXTURE2,
    TEX_THREE = GL_TEXTURE3,
    TEX_FOUR = GL_TEXTURE4,
    TEX_FIVE = GL_TEXTURE5,
    TEX_SIX = GL_TEXTURE6,
    TEX_SEVEN = GL_TEXTURE7,
    TEX_EIGHT = GL_TEXTURE8,
    TEX_NINE = GL_TEXTURE9,
    TEX_TEN = GL_TEXTURE10,
};
